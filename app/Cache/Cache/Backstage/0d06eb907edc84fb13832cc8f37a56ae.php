						...
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													...
													<input type="text"  class="form-control  must" name="name" value="<?php echo ($data['name']); ?>" placeholder="请输币的名称"  />
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													...
													<input type="text"  class="form-control  must float" name="exchange_rate" value="<?php echo ($data['exchange_rate']); ?>" placeholder="请输入汇率"  />
									...
									<div class="form-group">
										<label class="col-md-3 control-label">钱包地址</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must" name="address" value="<?php echo ($data['address']); ?>" placeholder="请输入钱包地址"  />
									...
									<div class="form-group">	
										<label class="col-md-3 control-label">记录查询接口</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must" name="select_link" value="<?php echo ($data['select_link']); ?>" placeholder="请输入记录查询接口"  />
								...
								<div class="form-group">								
									...
									<a href="adminapi.html?url=admin_coin_edit" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">保存编辑</a>
