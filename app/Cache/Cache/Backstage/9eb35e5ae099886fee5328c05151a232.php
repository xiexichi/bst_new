					...
					<div class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a href="password"><i class="fa fa-wrench"></i>修改密码</a>
								</li>
...
<!----------------------------------------------------------------------------------------------------------->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-user"></i>用户管理</li>
								<li></i>用户详情</li>
							</ol>						
						</div>
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>用户详情</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
										...
										<div class="col-md-9">
										<p class="form-control-static"><?php echo ($data["userid"]); ?></p>
										</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
										<label class="col-md-3 control-label">会员头像</label>
										<div class="col-md-9">
										<p class="form-control-static">	<img style="max-width:150px;" src="<?php if(!empty($data["headimgurl"])): echo ($data["headimgurl"]); else: ?>http://a4.att.hudong.com/85/94/20300542517430139831940804045_140.jpg<?php endif; ?>"/></p>
										</div>
										</div>
										<div class="form-group">
										<div class="col-md-9">
										...
										<a href="adminapi.html?url=admin_member_del" class="btn btn-default ajax-post" data-plugin-colorpicker="" data-color-format="hex" data-color="rgb(42,111,244)" target-form="myform" callback="edit_callback" check-data="true">用户禁用</a>
										<div class="radio-custom radio-inline"></div>
										<?php else: ?>
										<input type="text"  name="status" value="1" class="hide">
										<a href="adminapi.html?url=admin_member_del" class="btn btn-success ajax-post" data-plugin-colorpicker="" data-color-format="hex" data-color="rgb(42,111,244)" target-form="myform" callback="edit_callback" check-data="true">解除封号</a>
		...
		<script src="/bst/template/Npts/assets/js/pages/membe-edit.js"></script>
