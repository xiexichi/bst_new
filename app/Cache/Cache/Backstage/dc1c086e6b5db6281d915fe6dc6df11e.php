...
<html lang="en">
	...
	<head>
		...
		<link href="/liwenjian/www/vatc/template/Npts/assets/plugins/summernote/css/summernote.css" rel="stylesheet" />
		<link href="/liwenjian/www/vatc/template/Npts/assets/plugins/summernote/css/summernote-bs3.css" rel="stylesheet" />
		<link href="/liwenjian/www/vatc/template/Npts/assets/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" />
...
<!-- head.html  -->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="JavaScript:;"><i class="icon fa fa-list-alt"></i>系统设置</a></li>
								<li class="active"><i class="fa fa-pencil-square-o"></i>页面生成</li>								
							</ol>						
						</div>
						...
						<div class="col-xs-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-edit red"></i>页面编辑</h6>						
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered">
										<div class="form-group">									
											<div class="col-md-10">
												<div class="summernote" data-plugin-summernote data-plugin-options='{ "height": 500,"onImageUpload":"sendFile"}'></div>
											</div>
											<div class="col-md-2">
												
												<hr/>
												<button type="button" onclick="abc();" class="btn btn-primary">生成页面</button>
											</div>
										</div>
									</form>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title bk-fg-primary">生存页面成功</h4>
					</div>
					<div class="modal-body">
						<span>访问地址：</span><span class="bk-fg-danger" id="url">https://www.baidu.com</span>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" id="copy" value="https://www.baidu.com" onclick="JavaScript:;">复制链接</button>
						<a id="click-res" href="http://www.baidu.com" target="_blank" class="btn btn-primary">点击浏览</a>
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title bk-fg-primary text-center">功能未开放</h4>
					</div>
				</div>
			</div>
		</div>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/public/js/menu.js"></script>
		<!-- Plugins JS-->
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/plugins/summernote/js/summernote.js"></script>
		<script src="/liwenjian/www/vatc/template/Npts/assets/plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>
		<script src="/liwenjian/www/vatc/template/Npts/assets/plugins/bootstrap-markdown/js/markdown.js"></script>
		<script src="/liwenjian/www/vatc/template/Npts/assets/plugins/bootstrap-markdown/js/to-markdown.js"></script>
		...
		<!-- Pages JS -->
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/form-editors.js"></script>
		...
		<script type="text/javascript">
			...
			if(sHTML && sHTML!='<p><br></p>'){
				var url=head_url+"api?url=admin_page_success";
				var query={};
				query['html']=sHTML;
				$.post(url,query).success(function(data){
            	 if(data.errno==0){
            	 	$("#url").html(data.data);
            	 	$("#click-res").attr('href',data.data);
            	 	$("#copy").val(data.data);
            	 	$('#myModal') .modal('show');
            	 }else{
