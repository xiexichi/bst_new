...
<!----------------------------------------------------------------------------------------------------------->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-indent"></i>EOS交易记录</li>
							</ol>						
						</div>
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered myform">					
										...
										<div class="form-group">
											...
											<div class="col-md-6">
											<a class="btn btn-primary ajax-post" href="adminapi.html?url=admin_record_lists" id="in-list-click" target-form="myform"  callback="in_callback">查 询</a>
											</div>
										</div>
									</form>										
								</div>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/record-in.js"></script>
