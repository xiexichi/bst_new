...
<html lang="en">
	...
	<head>
		...
		<link href="/bst/template/Npts/assets/plugins/summernote/css/summernote.css" rel="stylesheet" />
		<link href="/bst/template/Npts/assets/plugins/summernote/css/summernote-bs3.css" rel="stylesheet" />
		<link href="/bst/template/Npts/assets/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" />
...
<!----------------------------------------------------------------------------------------------------------->	
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>站内信详情</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
										<div class="form-group">
											<input type="text"  class="form-control hide" name="id" value="<?php echo ($_GET['id']); ?>" placeholder="请输入标题" />						
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">
													<span class="input-group-addon">
														...
														<input type="text"  class="form-control  must" name="title" value="<?php echo ($data['title']); ?>" placeholder="请输入标题" />
													</div>
													<span class="help-block hide"></span>
											</div>
										</div>
										<div class="form-group">								
											<label class="col-md-3 control-label">描述（非必填）</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">
													<span class="input-group-addon">
															<i class="fa  fa-tag"></i>
														</span>
														<input type="text"  class="form-control" name="description" value="<?php echo ($data['description']); ?>" placeholder="描述" />
													</div>
													<span class="help-block hide"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="summernote" upload_imgurl="<?php echo U('file/update');?>" data-plugin-summernote data-plugin-options='{ "height": 500,"onImageUpload":"sendFile"}'><?php echo ($data["content"]); ?></div>
											</div>
										</div>
										<div class="form-group">								
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">
													...
													<input type="text"  class="form-control" name="mobile" value="<?php echo ($data['mobile']); ?>" placeholder="用户手机" />
												</div>
												<span class="help-block hide"></span>
											</div>
										</div>
										<div class="form-group">								
											...
											<div class="col-md-9">
											<a href="#" onclick="abc();" class="btn btn-success" callback="edit_callback">确认提交</a>
		...
		<script src="/bst/template/Npts/assets/plugins/summernote/js/summernote.js"></script>	
		...
		<script src="/bst/template/Npts/assets/js/pages/form-editors.js"></script>
		...
		<script type="text/javascript">	
			...
			if(sHTML && sHTML!='<p><br></p>'){
				var url=head_url+"adminapi.html?url=admin_mail_success";
				var query={};
				query['content']=sHTML;
				query['title']=$('input[name="title"]').val();
				query['mobile']=$('input[name="mobile"]').val();
				query['id']='<?php echo ($_GET['id']); ?>';
