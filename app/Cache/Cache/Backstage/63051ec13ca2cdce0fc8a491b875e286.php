...
<!----------------------------------------------------------------------------------------------------------->	
									...
									<div class="form-group">								
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												...
												<?php if(empty($data["img_path"])): ?><img id="img_path" style="max-width:150px" src="/bst/template/Npts/assets/img/add.jpg">
		...
		<script src="/bst/template/Npts/assets/js/pages/banner-edit.js"></script>
