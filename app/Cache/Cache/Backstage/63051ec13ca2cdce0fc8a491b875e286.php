...
<!----------------------------------------------------------------------------------------------------------->	
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>轮播详情</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
									<div class="form-group">
									<input type="text"  class="form-control hide" name="id" value="<?php echo ($_GET['id']); ?>" placeholder="请输入轮播标题" />								
										<label class="col-md-3 control-label">轮播标题</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must" name="title" value="<?php echo ($data['title']); ?>" placeholder="请输入轮播标题" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									<div class="form-group">								
										<label class="col-md-3 control-label">资源描述（非必填）</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control" name="description" value="<?php echo ($data['description']); ?>" placeholder="资源描述" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
													...
													<input type="text"  class="int form-control" name="sort" value="<?php echo ($data['sort']); ?>" placeholder="排序" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">轮播分类</label>
										<div class="col-sm-3">
										<select class="form-control" name="classid" id="banner_category">
										<?php if(is_array($class)): foreach($class as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo['id']) == $data['classid']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; ?>
										</select>
										</div>
									</div>
									<div class="form-group">								
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<textarea type="text"  class="int form-control" name="sort" value="" placeholder="排序" ><?php echo ($data['sort']); ?></textarea>
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
										<div class="form-group">
											<label class="col-md-3 control-label">资源封面</label>
											<div class="col-md-6">
												<a style="max-width:160px" class="thumbnail imgadd" href="javascript:;" onclick="getElementById('inputfile').click()">
												<?php if(empty($data["img_path"])): ?><img id="img_path" style="max-width:150px" src="/liwenjian/www/vatc/template/Npts/assets/img/add.jpg">
											
											<?php else: ?>
											<img id="img_path" style="max-width:150px" src="<?php echo ($data["img_path"]); ?>"><?php endif; ?>
											</a>
											<input type="text"  value="<?php echo ($data["img_path"]); ?>" name="img_path" class="hide"/>
											</div>
										</div>
										<div class="form-group">								
										<label class="col-md-3 control-label">作品id</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="int form-control" name="link" value="<?php echo ($data['link']); ?>" placeholder="作品id" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									...
									<div class="col-md-9">
									<a href="adminapi.html?url=admin_banner_success" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">确认提交</a>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/banner-edit.js"></script>
