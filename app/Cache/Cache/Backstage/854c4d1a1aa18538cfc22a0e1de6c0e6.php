...
<!----------------------------------------------------------------------------------------------------------->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-jpy"></i>交易管理</li>
								<li>提现详情</li>
							</ol>						
						</div>
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>提现详情</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
										...
										<div class="form-group">				
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['coin_type']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">提币金额</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['number']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">提币地址</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control" name="asset" value="<?php echo ($data['asset']); ?>" placeholder="提币地址" />
												</div>
											</div>
										</div>
										<div class="form-group">				
											...
											<div class="col-md-9">
												<div class="radio-custom radio-inline">
													<input type="radio" id="inline-radio1" <?php if(($data["status"]) == "2"): ?>disabled<?php endif; ?> <?php if(($data["status"]) == "-1"): ?>checked disabled<?php endif; ?> name="status" value="-1"> 
													<label for="inline-radio1"> 不通过</label>
												</div>
												<div class="radio-custom radio-inline">
													<input type="radio" <?php if(($data["status"]) == "-1"): ?>disabled<?php endif; ?> <?php if(($data["status"]) == "2"): ?>disabled<?php endif; ?> <?php if(($data["status"]) == "1"): ?>checked<?php endif; ?> id="inline-radio2" name="status" value="1"> 
													<label for="inline-radio2"> 申请中</label>
												</div>
												<div class="radio-custom radio-inline">
													<input type="radio" id="inline-radio3"  <?php if(($data["status"]) == "2"): ?>checked disabled<?php endif; ?> name="status" value="2"> 
													<label for="inline-radio3"> 通过</label>
												</div>
											</div>
										</div>
										<div class="form-group">
										<div class="col-md-9">
											<?php if(($data["status"]) == "1"): ?><input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>" />
											<a href="adminapi.html?url=admin_asset_success" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">确认提交</a>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/asset-edit.js"></script>
