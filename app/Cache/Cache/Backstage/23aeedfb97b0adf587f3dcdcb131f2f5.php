...
<!----------------------------------------------------------------------------------------------------------->	
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-search"></i>激活管理</li>
								<li>激活列表</li>
							</ol>						
						</div>
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered myform">	
										...
										<div class="form-group">
											...
											<div class="col-md-6">
											<a class="btn btn-primary ajax-post" href="adminapi.html?url=admin_activeorder_list" id="in-list-click" target-form="myform"  callback="in_callback">查 询</a>
											</div>
										</div>
									</form>										
								</div>
					...
					<div class="row" id="member_list">					
						<div class="col-lg-12">                           
							<div class="panel">                                
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-table red"></i><span class="break"></span>激活列表</h6>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/activeorder.js"></script>
	</body>
