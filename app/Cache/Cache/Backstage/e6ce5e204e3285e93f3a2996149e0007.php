					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-picture-o"></i>推广设置</li>
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>设置详情</h6>							
								</div>
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<label class="col-md-3 control-label">满足总业绩</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must float" name="condition" value="<?php echo ($data['condition']); ?>" placeholder="请输入满足总业绩"  />
												</div>
									...
									<div class="form-group">							
										<label class="col-md-3 control-label">团队收益（百分比）</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must float" name="bonus" value="<?php echo ($data['bonus']); ?>" placeholder="请输入团队收益（百分比）"  />
													<span class="input-group-addon">
														<i class="fa">%</i>
													</span>
												</div>
									...
									<div class="form-group">							
										<label class="col-md-3 control-label">管理收益（百分比）</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must float" name="spread" value="<?php echo ($data['spread']); ?>" placeholder="请输入管理收益（百分比）"  />
													<span class="input-group-addon">
														<i class="fa">%</i>
													</span>
												</div>
									...
									<div class="form-group">							
										<label class="col-md-3 control-label">分红类型</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													...
													<select class="form-control" name="type">
													  <option value ="1" <?php if(($data["type"]) == "1"): ?>selected<?php endif; ?>>静态+动态</option>
													  <option value="2" <?php if(($data["type"]) == "2"): ?>selected<?php endif; ?>>静态</option>
													  <option value="3" <?php if(($data["type"]) == "3"): ?>selected<?php endif; ?>>动态</option>
													</select>
												</div>
								...
								<div class="form-group">								
									...
									<a href="adminapi.html?url=admin_node_setup_edit" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">保存编辑</a>
