					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-wrench"></i>权限管理</li>
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>管理员详情</h6>							
								</div>
								<div class="panel-body">
									...
									<input type="text"  class="form-control hide" name="id" value="<?php echo ($_GET['id']); ?>"/>								
										<label class="col-md-3 control-label">管理员昵称</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must" name="nickname" value="<?php echo ($data['nickname']); ?>" placeholder="请输入管理员昵称" />
												</div>
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
													...
													<input type="text"  class="form-control  must" name="username" <?php if(!empty($data["username"])): ?>value="<?php echo ($data['username']); ?>" disabled<?php endif; ?> placeholder="帐号" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									<div class="form-group">								
										...
										<div class="col-md-9">
										<a href="adminapi.html?url=admin_admin_success" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">确认提交</a>
