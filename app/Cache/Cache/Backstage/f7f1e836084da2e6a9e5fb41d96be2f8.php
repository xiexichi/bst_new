						...
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													...
													<input type="text"  class="form-control  must" name="level" value="第<?php echo ($data['level']); ?>代会员" placeholder="请输入层级"  disabled="disabled" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									<div class="form-group">								
										<label class="col-md-3 control-label">满足直推数</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control must int" name="condition" value="<?php echo ($data['condition']); ?>" placeholder="请输入满足直推数"/>
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									...
									<div class="form-group">							
										<label class="col-md-3 control-label">分红比例（百分比）</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must float" name="bonus" value="<?php echo ($data['bonus']); ?>" placeholder="请输入分红比例（百分比）"  />
													<span class="input-group-addon">
														<i class="fa">%</i>
													</span>
												</div>
								...
								<div class="form-group">								
									...
									<a href="adminapi.html?url=admin_distribution_setup_edit" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">保存编辑</a>
