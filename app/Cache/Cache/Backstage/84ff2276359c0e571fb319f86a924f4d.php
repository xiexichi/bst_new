...
<!----------------------------------------------------------------------------------------------------------->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-cny"></i>交易管理</li>
								<li class="active"><i class="fa fa-indent"></i>VETH充币</li>
							</ol>						
						</div>
						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>VETH充币</h6>						
								</div>
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered myform">					
										<div class="form-group">								
											...
											<div class="col-md-6">
											<div class="input-group ccol-md-6">
													
													<input type="text"  class="form-control  must" name="mobile" value="" placeholder="请输入手机号码" />
												</div>
										...
										<div class="form-group">								
											...
											<div class="input-group ccol-md-6">
													...
													<input type="text"  class="form-control  must float" name="money" value="" placeholder="请输入充值金额" />
												</div>
												<span class="help-block hide"></span>
										</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-6">
											<a class="btn btn-primary ajax-post" href="adminapi.html?url=admin_balance_in" id="in-list-click" target-form="myform"  callback="in_callback">充 值</a>
											</div>
										</div>
									</form>										
								</div>
		...
		<script src="/shadow/vatc/template/Npts/assets/js/pages/balance-in.js"></script>
