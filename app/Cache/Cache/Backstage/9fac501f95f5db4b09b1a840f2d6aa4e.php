...
<!----------------------------------------------------------------------------------------------------------->	
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-cny"></i>汇率设置</li>
								<li class="active"><i class="fa fa-indent"></i>汇率详情</li>
							</ol>						
						</div>
						...
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>汇率详情</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
										<div class="form-group">								
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" data-plugin-datepicker class="form-control must" name="time" value="" placeholder="请输入日期"/>
										...
										<div class="form-group">								
											<label class="col-md-3 control-label">倍率</label>
											<div class="col-md-6">
											<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-btc"></i>
													</span>
													<input type="text"  class="form-control must float" name="money" value="" placeholder="请输入倍率" />
												</div>
												<span class="help-block hide"></span>
										</div>
									</div>
									...
									<div class="col-md-9">
									<a href="adminapi.html?url=admin_price_success" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">确认提交</a>
		...
		<script src="/shadow/vatc/template/Npts/assets/public/js/menu.js"></script>	
		...
		<script src="/shadow/vatc/template/Npts/assets/public/js/ajax.js"></script>
		<script src="/shadow/vatc/template/Npts/assets/js/pages/price-edit.js"></script>
