...
<!----------------------------------------------------------------------------------------------------------->	
				...
				<div class="main ">
					...
					<div class="row hide" id="member_button">
						<div class="col-lg-12">
							<div class="panel">
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered myform">	
										...
										<div class="form-group">
											<label for="tags-input-multiple" class="col-md-3 control-label">姓名（可多值）</label>
											<div class="col-md-7">
												<select name="nickname[]" id="nickname" multiple data-role="tagsinput" data-tag-class="label label-primary">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
											<a class="btn btn-primary ajax-post" href="adminapi.html?url=admin_member_list" id="in-list-click" target-form="myform"  callback="in_callback">查 询</a>
											</div>
										</div>
									</form>										
								</div>
					...
					<div class="row hide" id="member_list">					
						<div class="col-lg-12">                           
							<div class="panel">                                
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-table red"></i><span class="break"></span>前台用户</h6>
								</div>										
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/member.js"></script>
