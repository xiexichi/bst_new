...
<html lang="en">
	...
	<body>
						...
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="text-center">
								...
								<a href="javascript: history.go(-1)">
									<button type="button" class="btn btn-primary"><i class="fa fa-chevron-left"></i>返回上一页</button>
								</a>
								<a href="login.html">
									<button type="button" class="btn btn-primary"><i class="fa fa-lock"></i> 登录</button>
								</a>
								<a href="mailto:m89520@163.com">
									<button type="button" class="btn btn-primary"><i class="fa fa-envelope"></i>联系管理员</button>
								</a>
							</div>						
						</div>					
					</div>			
		...
		<!-- Pages JS -->
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/page-404.js"></script>
