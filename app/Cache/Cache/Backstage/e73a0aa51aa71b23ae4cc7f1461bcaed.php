...
<!----------------------------------------------------------------------------------------------------------->	
				...
				<div class="main ">
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-table"></i>统计管理</li>
								<li>数据统计</li>
							</ol>						
						</div>
					...
					<div class="row" id="member_button">
						<div class="col-lg-12">
							<div class="panel">
								...
								<div class="panel-body bk-bg-white bk-padding-top-30 bk-padding-bottom-20">
									<form class="form-horizontal form-bordered myform">	
										...
										<div class="form-group">
											<label for="tags-input-multiple" class="col-md-3 control-label">用户手机（可多值）</label>
											<div class="col-md-7">
												<select name="mobile[]" id="nickname" multiple data-role="tagsinput" data-tag-class="label label-primary">
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<select name="type"  class="form-control" >
													...
													<option value="4">利息</option>
													<option value="5">充值</option>
													<option value="6">提现</option>
													<option value="7">激活卡交易</option>
												</select>
											</div>
										</div>
										<div class="form-group hide" id="style1">
											<label class="col-md-3 control-label">激活卡交易类型</label>
											<div class="col-sm-3">
												<select name="style1"  class="form-control" >
													<option value="">全部显示</option>
													<option value="1">激活卡挂单</option>
													<option value="2">购买激活卡</option>
													<option value="3">出售激活卡</option>
													<option value="4">系统退回</option>
													<option value="5">兑换激活卡</option>
												</select>
											</div>
										</div>
										<div class="form-group hide" id="style2">
											<label class="col-md-3 control-label">收益类型</label>
											<div class="col-sm-3">
												<select name="style2"  class="form-control" >
													<option value="">全部显示</option>
													<option value="1">注册红包</option>
													<option value="2">签到奖励</option>
													<option value="3">推荐奖励</option>
													<option value="4">管理奖励</option>
													<option value="5">领导奖励</option>
													<option value="6">静态奖励</option>
												</select>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
											<a class="btn btn-primary ajax-post" href="adminapi.html?url=admin_transaction_list" id="in-list-click" target-form="myform"  callback="in_callback">查 询</a>
											</div>
										</div>
									</form>										
								</div>
					...
					<div class="row" id="member_list">					
						<div class="col-lg-12">                           
							<div class="panel">                                
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-table red"></i><span class="break"></span>数据统计</h6>
		...
		<script src="/liwenjian/www/vatc/template/Npts/assets/js/pages/transaction.js"></script>
		...
		<script>
			$('select[name="type"]').change(function(){
				var type=$(this).val();
				if(type==4){
					$('select[name="style1"]').val('');
					$('select[name="style2"]').val('');
