						...
						<div class="col-md-12">
							<div class="panel">
								...
								<div class="panel-body">
									...
									<div class="form-group">								<input type="text"  class="form-control hide" name="id" value="<?php echo ($_GET['id']); ?>"/>
										<label class="col-md-3 control-label">第几次释放</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
												<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control must int" name="month" value="<?php echo ($data['month']); ?>" placeholder="请输入第几次释放" disabled="disabled"/>
												</div>
									...
									<div class="form-group">							
										<label class="col-md-3 control-label">释放比例（百分比）</label>
										<div class="col-md-6">
											<div class="input-group col-sm-7">
													<span class="input-group-addon">
														<i class="fa  fa-tag"></i>
													</span>
													<input type="text"  class="form-control  must float" name="ratio" value="<?php echo ($data['ratio']); ?>" placeholder="请输入释放比例（百分比）"  />
													<span class="input-group-addon">
														<i class="fa">%</i>
													</span>
												</div>
								...
								<div class="form-group">								
									...
									<a href="adminapi.html?url=admin_quicken_setup_list_edit" class="btn btn-success ajax-post"  target-form="myform" callback="edit_callback">保存编辑</a>
