								...
								<div class="panel-body">
									<form action="" method="post" enctype="multipart/form-data" class="form-horizontal myform">
										...
										<div class="form-group">				
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['eos']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['finally']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">每日释放率（百分比）</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['everyday']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">已释放的数量</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['release']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											...
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['veth']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">激活等级</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['setup_id']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">				
											<label class="col-md-3 control-label">veth 激活个数</label>
											<div class="col-md-6">
												<div class="input-group col-sm-7">	
													<span class="help-block"><?php echo ($data['veth_num']); ?></span>
												</div>
											</div>
										</div>
										<div class="form-group">
