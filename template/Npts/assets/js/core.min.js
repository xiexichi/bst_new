...
(function( $ ) {
	...
	$(document).on('click','.nav-sidebar > li.nav-parent', function() {
...
$(document).on('click','.nav-sidebar > li.nav-parent .nav-children a', function(ev) {
		ev.stopPropagation();
	});
...
function outlogin_callback(data){
  if (data.status==1) {
